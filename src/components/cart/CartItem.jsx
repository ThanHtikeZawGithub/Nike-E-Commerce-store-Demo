  ...
  return (
    ...
    <div className='flex items-center justify-between w-full px-5'>
        ...
        <div className='grid items-center gap-4'>
          ...
          <div className='flex items-center justify-around w-full'>
            <button type='button' onClick={OnDecreaseQty} className='bg-theme-cart rounded w-6 h-6 lg:w-5 lg:h-5 flex items-center justify-center active:scale-90 '>
              <MinusIcon className='h-5 w-5 lg:w-4 lg:h-4 text-white stroke-[2]'/>
              </button>
            ...
            <button type='button' onClick={OnIncreaseQty} className='bg-theme-cart rounded w-6 h-6 lg:w-5 lg:h-5 flex items-center justify-center active:scale-90'>
              <PlusIcon className='h-5 w-5 lg:w-4 lg:h-4 text-white stroke-[2]'/>
              </button>
          </div>
        </div>
      </div>
      <div className='grid items-center gap-5'>
        ...
        <div className='grid items-center justify-center'>
          <button type='button' onClick={onRemoveItem} className='bg-theme-cart rounded p-1 lg:p-0.5
          grid items-center justify-items-center cursor-pointer'><TrashIcon className='w-5 h-5 text-white  '/></button>
        </div>
      </div>
    </div>
      </>
