                ...
                <nav className='flex items-center justify-between nike-container'>
                    <div>
                        <img
                            src={logo}
                            alt='logo/img'
                            className={`w-16 h-auto ${navState && 'text-slate-900 transition-all duration-300'}`}
                        />
                    </div>
                    <ul className='flex items-center justify-between gap-2'>
                        ...
                        text-[0.65rem] leading-tight font-[medium] rounded-full flex items-center justify-center cursor-pointer
                        hover:scale-110 transition-all duration-300 ${navState ? 'bg-slate-900 text-slate-100 shadow-slate-900' : 'bg-slate-100 text-slate-900 shadow-slate-100'}`}>{totalQuantity}</div>
                            </button>
                        </li>
                    </ul>
                </nav>
